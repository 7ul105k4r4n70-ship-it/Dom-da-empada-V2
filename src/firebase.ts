...
import { getAuth, GoogleAuthProvider, signInWithPopup, signInWithRedirect, getRedirectResult, signOut, onAuthStateChanged, signInWithEmailAndPassword, createUserWithEmailAndPassword, User as FirebaseUser } from 'firebase/auth';
...
export async function seedInitialData() {
  ...
  // Seed Users
  const sampleUsers = [
    { name: 'Ricardo Mendes', email: 'ricardo.mendes@domdaempada.com', role: 'admin', region: 'Recife', status: 'Ativo', photoUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=100&auto=format&fit=crop' },
    { name: 'Mariana Silva', email: 'mariana.silva@domdaempada.com', role: 'usuario', region: 'Salvador', status: 'Ativo', photoUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=100&auto=format&fit=crop' }
  ];
